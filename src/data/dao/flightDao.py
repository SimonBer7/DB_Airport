...
class FlightDao:
    ...
    def insert(self, flight):
        try:
            ...
            values = (int(flight.get_fly_number()), int(flight.get_destination_id()), int(flight.get_plane_id()), int(flight.get_pilot_id()), datetime.datetime.strptime(flight.get_date_leaving(), "%Y-%m-%d").date(), datetime.datetime.strptime(flight.get_date_arriving(), "%Y-%m-%d").date(), int(flight.get_price()))
    ...
    def read_flight_id(self, fly_num):
        try:
            ...
            if flight_id:
                ...
                return "There isn't flight with this number"
        except ValueError:
            print("Error invalid format")
        except Exception:
            print("Error with reading from database")
    ...
    def read_flight_price(self, fly_num):
        try:
            ...
            print("Error with reading price from database")
